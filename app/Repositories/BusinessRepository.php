...
class BusinessRepository
{
    ...
    public function getBusiness($id)
    {
        $business = DB::table('businesses as b')
            ...
            ->leftjoin('users as u', 'bur.user_id', '=', 'u.id')
            ->where('b.id', '=', $id)
            ->select('b.*', 'mp.name as membership_plan', 'u.name as owner_name', 'u.email as owner_email', 'u.mobile_number as owner_mobile_number', 'u.active as owner_active', 'u.created_at as owner_created_at', 'u.updated_at as owner_updated_at', 'u.deleted_at as owner_deleted_at')
            ->first();
    ...
    /**
     * Get a membership plan of a business
     *
     * @param $business_id
     * @return mixed
     */
