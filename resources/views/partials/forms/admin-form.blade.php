...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <img style="width:150px;height:150px;float:left;" id="img_profile_picture"
             @if (isset($admin) && $admin->profile_picture) src="{{ $admin->profile_picture }}"
        ...
        <div class="col-sm-10">
            ...
            @if (isset($admin) && $admin->profile_picture)
                <a class="btn btn-sm btn-danger" style="margin-top: 10px" type="button" onClick="deleteProfilePicture({{ $admin->id }})"><i
